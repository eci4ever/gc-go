...
import { organizationAuditQueryOptions } from '@/lib/organizations'
    ...
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{pagination?.total ?? 0} recorded events</CardDescription>
        </CardHeader>
        <CardContent className="divide-y p-0">
          {query.data?.events.map((event) => (
            <div key={event.id} className="grid gap-1 px-6 py-4 sm:grid-cols-[1fr_auto]">
              <div>
