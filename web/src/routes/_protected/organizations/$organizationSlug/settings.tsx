    ...
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          ...
          <Field label="Logo URL"><Input value={logo} onChange={(event) => setLogo(event.target.value)} /></Field>
          <Field label="Metadata"><Input value={metadata} onChange={(event) => setMetadata(event.target.value)} /></Field>
          <div className="sm:col-span-2">
            <Button disabled={!name || !slug || update.isPending} onClick={() => update.mutate()}>
          ...
          <Dialog open={transferOpen} onOpenChange={setTransferOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>This action changes your role to admin.</DialogDescription>
              </DialogHeader>
